  ...
  return <section id="publications">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {publications.map((publication, index) => <Card key={index} className="flex flex-col h-full hover:shadow-md transition-shadow">
              <div className="aspect-video w-full overflow-hidden rounded-t-lg">
                <img src={publication.image} alt={publication.title} className="h-full w-full object-cover transition-transform hover:scale-105 duration-500" />
              </div>
              <CardHeader>
              ...
              <CardFooter>
                <Button variant="outline" className="w-full" asChild>
                  <a href={publication.link} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
        ...
        <div className="mt-12 text-center">
          <Button variant="outline" asChild>
            <a href="https://linkedin.com/company/lunae" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
