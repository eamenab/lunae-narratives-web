...
const ServicesSection = () => {
  return <section id="services" className="bg-muted/50 dark:bg-muted/10">
      <div className="container">
        <h2 className="section-title">Qué hacemos</h2>
        

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {services.map((service, index) => <div key={index} className="bg-background p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-border flex flex-col h-full">
